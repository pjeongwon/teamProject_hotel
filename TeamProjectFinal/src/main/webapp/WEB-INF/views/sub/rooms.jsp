				...
				<c:forEach var="roomDTO" items="${roomList }">
					<div class="col-md-4 mb-4">
						<div class="media d-block room mb-0">
							<figure>
								<img src="${pageContext.request.contextPath}/resources/upload/64ff8b79-2e57-4d15-b67c-1c4b98be40ad_room_standardOndol.jpg" alt="Generic placeholder image"	class="img-fluid">
